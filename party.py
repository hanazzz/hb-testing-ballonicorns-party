...
def most_and_least_common_type(treats):
    ...
    testing tie for least common type of food
    >>> most_and_least_common_type([{'type': 'dessert'}, {'type': 'appetizer'}, {'type': 'drink'}, {'type': 'dessert'}])
    ('dessert', 'appetizer')

    testing only one type of food
    >>> most_and_least_common_type([{'type': 'appetizer'}, {'type': 'appetizer'}, {'type': 'appetizer'}, {'type': 'appetizer'}])
    ('appetizer', 'appetizer')

    testing tie for most common type of food
    >>> most_and_least_common_type([{'type': 'appetizer'}, {'type': 'dessert'}, {'type': 'appetizer'}, {'type': 'dessert'}, {'type': 'drink'}])
    ('appetizer', 'drink')
